...
%Giới thiệu
Hướng tiếp cận phân chia là một trong những cách tiếp cận của gom nhóm phân cấp~\cite{Vipin-Kumar, hierarchical-clustering, cluster-analysis}.
...
%Giới thiệu
Gom nhóm phân cấp theo hướng tích tụ là hướng tiếp cận phổ biến nhất trong gom nhóm phân cấp~\cite{Vipin-Kumar, hierarchical-clustering, cluster-analysis}.
...
\label{sec:dpt}
%~\cite{Vipin-Kumar}
Thuật toán gom nhóm phân cấp tích tụ sử dụng ma trận tương đồng (ma trận khoảng cách) để xem xét độ tương đồng giữa các nhóm.
...
Phân tích dành cho hướng tiếp cận cơ bản của gom nhóm phân cấp tích tụ cho thấy độ phức tạp của thuật toán liên quan trực tiếp đến quá trình tính toán.
...
\section{Các phương pháp liên kết trong gom nhóm phân cấp tích tụ}
\label{sec:cpplk}
...
Hình \ref{fig:pic22} (dựa vào hình 8.14(a)~\cite{Vipin-Kumar}) cho ta thấy gom nhóm phân cấp tích tụ theo kỹ thuật liên kết đơn.
\begin{figure}[htp]
...
\label{sec:lkd}	
%Giói thiệu
Liên kết đơn hay kỹ thuật nhỏ nhất trong gom nhóm phân cấp tích tụ là phương pháp xem độ tương đồng của hai nhóm là khoảng cách gần nhất của hai điểm bất kì trong mỗi nhóm~\cite{Vipin-Kumar, HAC, AHC, hierarchical-clustering, single-complete, explain-HAC}. 
...
%Chi tiết
Nhìn vào hình \ref{fig:pic26} (dựa vào hình 8.16~\cite{Vipin-Kumar}), ta thấy được kết quả của việc ứng dụng kỹ thuật liên kết đơn trong gom nhóm phân cấp tích tụ đối với dữ liệu ở \ref{fig:pic25}.
...
%Chi tiết
Hình \ref{fig:pic27} (dựa vào hình 8.17~\cite{Vipin-Kumar}) cho ta thấy được kết quả của việc áp dụng kỹ thuật liên kết toàn vẹn trong gom nhóm phân cấp tích tụ.
...
\label{sec:ntb}
Trong kỹ thuật nhóm trung bình của gom nhóm phân cấp tích tụ, độ tương đồng của hai nhóm được định nghĩa là độ trung bình của các cặp điểm ở 2 nhóm khác nhau~\cite{Vipin-Kumar, HAC, AHC, hierarchical-clustering, average}.
...
Hình \ref{fig:pic28} (dựa vào hình 8.18~\cite{Vipin-Kumar}) thể hiện kết quả của gom nhóm phân cấp tích tụ theo kỹ thuật nhóm trung bình.
...
Gom nhóm phân cấp tích tụ theo điểm trung tâm tính độ tương đồng của 2 nhóm bằng cách tính độ tương đồng của 2 điểm trung tâm trong mỗi nhóm~\cite{Vipin-Kumar, AHC, hierarchical-clustering, centroid}.
...
\section{Những vấn đề trong gom nhóm phân cấp tích tụ}
\subsection{Thiếu hàm mục tiêu toàn cục}
%~\cite{Vipin-Kumar}
Gom nhóm phân cấp tích tụ không có hàm mục tiêu toàn cục để có thể tối ưu.
