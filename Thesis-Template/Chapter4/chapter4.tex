...
Sau khi có được tập vector văn bản cần thiết từ mô hình doc2vec hay TFIDF, ta sẽ tiến hành gom nhóm phân cấp tích tụ với các tham số như sau: {\textit{n{\_}clusters}, \textit{linkage}, \textit{affinity}}.
Đối với ngữ liệu tiếng Việt, tham số \textit{n{\_}clusters} có giá trị là 300, còn đối với tiếng Anh là 96.
...
Trong scikitlearn, ta có các cách thức liên kết như sau: {``ward'', ``complete'', ``average''}.
