...
\section{Kết quả}
%Thực nghiệm kết quả
Sau đây, kết quả phần thực nghiệm của thuật toán HAC thực hiện trên dữ liệu tiếng Anh và tiếng Việt được thể hiện dưới các bảng sau (dấu x biểu thị thực nghiệm không thể thực hiện):
%
%\begin{table}[]
%\centering
%\resizebox{\textwidth}{!}{%
