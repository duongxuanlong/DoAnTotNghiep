...
Nếu ai muốn sử dụng bộ dữ liệu này thì phải đề cập đến nguồn~\footnote{http://www.research.att.com/~lewis} cũng như là trích dẫn thông tin của bộ dữ liệu trong đề tài nghiên cứu.
...
Bộ dữ liệu tiếng Việt được lấy từ trang tin tức tổng hợp Google news bao gồm 1945 bài được phân chia thành 300 phân nhóm.
