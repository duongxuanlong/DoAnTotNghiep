...
Trong nhiều ứng dụng, khái niệm về nhóm được định nghĩa không rõ ràng.
Cho nên, ta cần phải hiểu rõ một nhóm được tạo thành như thế nào trong quá trình gom nhóm.
...
Vì vậy, định nghĩa về nhóm chỉ mang tính tương đối và cách tiếp cận tốt nhất là ta phải dựa vào bản chất của dữ liệu và kết quả mong muốn.
...
Ngoài ra, ta còn có thêm hình dạng của các nhóm mờ với mỗi đối tượng thuộc về từng nhóm ứng với trọng số nằm trong khoảng từ 0 (không thuộc về) đến 1 (hoàn toàn thuộc về).
...
Để có cái nhìn tổng quát về các loại gom nhóm khác nhau, ta sẽ sử dụng dữ liệu là điểm có hai chiều.
...
\subsection{Gom nhóm văn bản phân chia}%~\cite{partitioning-clustering, partitioning-clustering-Krish}
Gom nhóm văn bản phân chia tạo thành các nhóm dựa vào số lượng $K$ nhóm cho trước với điều kiện $K$ nhỏ hơn số lượng văn bản.
...
\item[•]Cách tiếp cận này không thể xử lý nhiễu hoặc văn bản ngoại vi vì quá nhạy cảm với các văn bản ngoại vi.
\item[•]Hướng tiếp cận này không thích hợp đề tìm kiếm hình dạng các nhóm mà không phải là đa giác lồi.
\end{enumerate}

\subsection{Gom nhóm văn bản phân cấp} %~\cite{hierarchical-clustering}
Gom nhóm văn bản phân cấp tạo ra các nhóm lồng vào nhau thành cấu trúc cây phân cấp.
Phương pháp này có 2 cách tiếp cận khác nhau: gom nhóm phân cấp tích tụ  và gom nhóm phân cấp phân chia.
Gom nhóm phân cấp tích tụ bắt đầu mỗi nhóm là một văn bản rồi gom dần các văn bản lại với nhau cho đến khi chỉ còn một nhóm duy nhất.
Gom nhóm phân cấp phân chia bắt đầu với tất cả các văn bản là một nhóm lớn rồi chia dần nhóm này đến khi mỗi nhóm chỉ có một văn bản.
...
\subsection{Gom nhóm văn bản mật độ} %~\cite{density-clustering}
Gom nhóm văn bản mật độ xem mỗi văn bản như là tâm và với bán kính cho trước, ta tính khoảng cách từ tâm đến các văn bản khác và nếu khoảng cách này nhỏ hơn bán kính thì văn bản đó sẽ được gom lại vào thành một nhóm.
